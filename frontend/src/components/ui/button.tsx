...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  actionSave: "bg-[#5DCAA5] text-white hover:bg-[#5DCAA5]/90",
  ...
  rowActionSave: "border border-transparent bg-transparent text-[#27500A] hover:bg-[#EAF3DE] hover:text-[#27500A]",
