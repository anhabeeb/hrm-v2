...
registerRoutePreloader("employee-profile", () => EmployeeProfilePageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("employee-setup", () => EmployeeSetupListPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("employees", () => EmployeesPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("dashboard", () => DashboardPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("onboarding-case", () => OnboardingCaseWorkspacePageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("contracts", () => ContractsListPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("approvals", () => ApprovalInboxPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("attendance", () => AttendanceListPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("roster", () => RosterWeeklyPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("leave", () => LeaveRequestsPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("payroll", () => PayrollDashboardPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("payroll-run-detail", () => PayrollRunDetailPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("payroll-runs", () => PayrollRunsListPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("reports", () => ReportsPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("data-transfer", () => DataTransferPage.preload?.() ?? Promise.resolve());
registerRoutePreloader("documents", () => DocumentsRegistryPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("documents-compliance", () => DocumentsCompliancePageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("assets", () => AssetsDashboardPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("settings", () => SettingsHubPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("admin-settings", () => AdminSettingsPageV3.preload?.() ?? Promise.resolve());
...
registerRoutePreloader("users-access", () => UsersAccessUsersPageV3.preload?.() ?? Promise.resolve());
registerRoutePreloader("self-service", () => SelfServiceHomePageV3.preload?.() ?? Promise.resolve());
