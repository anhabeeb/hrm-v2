...
const checks = [
  ...
  check("Manual readiness refresh is queued", lifecycle.includes('onboardingRoutes.post("/cases/:caseId/refresh-readiness"') && lifecycle.includes("queueOnboardingReadinessRefresh(c, caseId, \"onboarding.workspace.readiness_manual_retry\")"), "Manual retry returns quickly and refreshes readiness in the background."),
