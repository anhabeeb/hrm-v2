...
assert(refreshRoute.includes("refreshWorkspaceReadiness") && refreshRoute.includes("workspaceWithConfirmedReadiness"), "manual readiness refresh is not direct/bounded");
