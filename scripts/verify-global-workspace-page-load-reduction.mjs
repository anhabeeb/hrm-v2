...
includes(lifecyclePage, "useWorkspaceQuery<Row>", "onboarding case popup loads workspace through workspace query");
includes(lifecyclePage, "api.getOnboardingWorkspace(token, caseId, signal)", "onboarding workspace query passes AbortSignal");
...
includes(lifecyclePage, "onboardingWorkspaceQuery.error", "onboarding background errors are handled without crashing");
