...
has(dashboardPage, "getKpiGroupSummary", "Collapsed KPI group summary helper is missing.");
...
has(dashboardPage, "flex w-full flex-wrap justify-center", "Dashboard KPI rows must wrap responsively and center incomplete rows.");
