...
for (const marker of ["PageShell", "CommandCenterHeader", "CommandCenterWelcome", "DashboardWidget", "PriorityKpiIconStrip", "Accordion", "CommandCenterKpiGrid"]) has(dashboard, marker, `dashboard ${marker}`);
