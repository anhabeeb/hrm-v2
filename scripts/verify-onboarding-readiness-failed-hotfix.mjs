...
check("frontend: generic-only failure message is not the only failure UI", lifecyclePage.includes("readinessFailureDetails") && lifecyclePage.includes("Reason") && lifecyclePage.includes("What to do next") && lifecyclePage.includes("Support details") && lifecyclePage.includes("Job ID:") && lifecyclePage.includes("Request ID:"));
